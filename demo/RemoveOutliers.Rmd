...
```{r read, warning=FALSE, message=FALSE, eval=FALSE}
library(ona)
...
```{r warning=FALSE, message=FALSE, fig.height=5, fig.width=9, eval=FALSE}
...
Option 1:
```{r message=FALSE, fig.height=5, fig.width=7,eval=FALSE}
